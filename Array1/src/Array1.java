...
public class Array1 {
	...
	public static void main(String[] args) {
		...
		a[2]=25;
		a[3]=35;
		//new int[배열범위(개수)] : 해당 범위는 실제 데이터 보다 무조건 커야함
		
		int ea =a.length;			//length : 배열의 개수를 파악할때 사용
		...
		//aa[] 배열 사용시 배열범위+값을 지속적으로 넣어야 하는 불편함이 있음. 버전이 변경되면서 a[] 배열값{}로 인식시킬수 있도록 변화
